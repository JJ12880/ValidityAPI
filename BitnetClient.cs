...
namespace ValidityAPI
{
    public class BitnetClient
    {
        ...
        public BitnetClient(RPC_Credentials credentials)
        {

            httpClient = new HttpClient(new HttpClientHandler() { Credentials = new NetworkCredential(credentials.User, credentials.Password) });
            Url = new Uri("http://" + credentials.Ip + ":" + credentials.Port);
        }

        public BitnetClient(Uri a_sUri, ICredentials creds)
        {
            httpClient = new HttpClient(new HttpClientHandler() { Credentials = creds });
            Url = a_sUri;
        }
        ...
        {
            return t_InvokeMethod(a_sMethod, a_params).Result;
        }

        public async Task<JObject> t_InvokeMethod(string a_sMethod, params object[] a_params)
        {
            ...
            var response = httpClient.PostAsync(Url, new StringContent(s, Encoding.UTF8, "application/json")).Result;
        ...
        private JObject old_InvokeMethod(string a_sMethod, params object[] a_params)
        {
        ...
        {
            return ((string)InvokeMethod("sendrawtransaction", tx)["result"]);
        }

        public string signrawtransaction(string tx)
        {
            return ((string)InvokeMethod("signrawtransaction", tx)["result"]["hex"]);
        }
        ...
        public JObject GetBlockByNumber(int a_height)
        {
            return (JObject)TryInvokeMethod("getblockbynumber", a_height.ToString())["result"];
        }

        public string getbestblockhash()
        {
            return (string)InvokeMethod("getbestblockhash")["result"];
        }
        ...
        public JObject gettxoutsetinfo()
        {
            return InvokeMethod("gettxoutsetinfo")["result"] as JObject;
        }
